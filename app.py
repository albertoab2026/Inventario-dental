...
# --- DEFINICIÓN DE LA FUNCIÓN DE AJUSTES ---
def mostrar_ajustes():
...
def mostrar_productos():
    ...
    if productos:
        ...
        df_editado = st.data_editor(df_mostrar[columnas_a_mostrar], key='editor_inventario', column_config={"producto_id": None}, use_container_width=True, height=400)
        ...
        producto_a_borrar = st.selectbox("Selecciona el producto a eliminar:", options=df_mostrar['nombre'].tolist(), key="selector_borrado")
...
# 1. PRIMERO DEFINIMOS LAS FUNCIONES (Para que el programa las conozca)
